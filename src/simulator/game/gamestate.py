...
class GameState:
    ...
    def play_turn_color_clue(self, action: ColorClueAction):
        clue = ColorClue(action.color, action.target_player.name, self.get_current_player().name, self.current_turn + 1)
        self.play_turn_clue(clue, action.target_player)

    def play_turn_rank_clue(self, action: RankClueAction):
        clue = RankClue(action.rank, action.target_player.name, self.get_current_player().name, self.current_turn + 1)
        self.play_turn_clue(clue, action.target_player)
